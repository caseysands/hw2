...
# TODO!
#In terminal, ran: rails generate model Movie, updated Movie migration file, ran rails db:migrate
#Repeated the above or each of the 4 tables
...
#movie_id int, actor_id int, character_name string
